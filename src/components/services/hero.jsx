...
const Service = () => {
  return (
    <div className="p-4 text-white">
       <div className="lg:pl-[60%] lg:pr-[5%] text-center lg:text-left">
        <h1
          className="text-[#F5F5F5] text-3xl lg:text-[64px] leading-snug lg:leading-[68px] py-8 lg:py-16"
          style={{ fontFamily: 'Italiana' }}
        >
          We Listen and Learn
        </h1>
        <div style={{ fontFamily: 'Poppins' }} className="text-sm lg:text-base px-4 lg:px-0">
          <p>
